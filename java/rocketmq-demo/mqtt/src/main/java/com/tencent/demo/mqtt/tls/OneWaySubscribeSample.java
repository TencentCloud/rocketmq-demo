...
public class OneWaySubscribeSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MqttConnectOptions options = Utils.buildMqttConnectOptions(USERNAME, PASSWORD, CLEAN_SESSION, CONNECT_TIMEOUT, CA_CERT_FILE_PATH);
            ...
            String topicFilter = FIRST_TOPIC + "/humidity/+";
            client.subscribe(topicFilter, 1);
            Utils.println("Subscribed to: " + topicFilter);
